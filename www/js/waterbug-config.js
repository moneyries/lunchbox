...
var logos = {
    'mashable-vert': {
        whitePath: '../img/mashable_white.png', // path to white logo
        blackPath: '../img/mashable_black.png', // path to black logo
        w: 75, // width of logo
        h: 97, // height of logo
        display: 'Mashable Vert'
    },
    'mashable-flat': {
        whitePath: '../img/mashable_flat_white.png',
        blackPath: '../img/mashable_flat_black.png',
        w: 300,
        h: 72,
        display: 'Mashable Flat'
    }
};
...
var fontFace = "Montserrat::latin"; // font family for credit
...
var currentLogo = 'mashable-vert'; // default logo slug
